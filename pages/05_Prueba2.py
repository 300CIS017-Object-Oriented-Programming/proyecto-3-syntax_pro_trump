...
df_original = pd.DataFrame({
    "CÓDIGO SNIES": [101, 102, 103],
    "PROGRAMA ACADÉMICO": ["Ingeniería", "Medicina", "Ingeniería"],
    "ADMITIDOS_2020": [150, 100, 180],
    "ADMITIDOS_2021": [200, 120, 210],
    "ADMITIDOS_2022": [180, 130, 190],
    "GRADUADOS_2021": [50, 40, 60],
    "Otra Info Irrelevante": ["Dato1", "Dato2", "Dato3"]
})

# Selección de palabra clave
keyword = st.selectbox("Archivos disponibles", options=["ADMITIDOS", "GRADUADOS", "INSCRITOS", "MATRICULADOS", "PRIMER CURSO"])
...
if keyword:
    ...
    if not columnas_relevantes:
        ...
        df_long["IDENTIFICADOR"] = df_long["PROGRAMA ACADÉMICO"] + " (SNIES: " + df_long["CÓDIGO SNIES"].astype(str) + ")"
